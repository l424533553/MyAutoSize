...
public class ExternalAdaptManager {
     ...
     * <p>
     * 支持链式调用, 如:
     * { ExternalAdaptManager#addCancelAdaptOfActivity(Class)#addCancelAdaptOfActivity(Class)}
     *
     ...
     * <p>
     * 支持链式调用, 如:
     * { ExternalAdaptManager#addExternalAdaptInfoOfActivity(Class, ExternalAdaptInfo)#addExternalAdaptInfoOfActivity(Class, ExternalAdaptInfo)}
     *
     * @param targetClass {@link Activity} class, Fragment class
