 ...
 * ================================================
 *
 * @author LUOFAXIN 自定义适配的Fragment
 */
public class CustomFragment1 extends Fragment implements CustomAdapt {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MyAutoSize.autoConvertDensity(getActivity(), 1080, true);
    ...
    public static View createTextView(LayoutInflater inflater, String content, int backgroundColor) {
        ...
        ViewGroup.LayoutParams layoutParams =
                new ViewGroup.LayoutParams((AutoSizeUtils.dp2px(inflater.getContext(), 360)), ViewGroup.LayoutParams.MATCH_PARENT);
