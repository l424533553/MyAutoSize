...
public final class AutoSize {
    ...
    public static void autoConvertDensity(Activity activity, float sizeInDp, boolean isBaseOnWidth) {
        Precondition.checkNotNull(activity, "activity == null");
    ...
    /**
     * 当 App 中出现多进程，并且您需要适配所有的进程，就需要在 App 初始化时调用 {@link  AutoSize #initCompatMultiProcess}
     * 建议实现自定义 {@link Application} 并在 {@link Application#onCreate()} 中调用 {@link  AutoSize #initCompatMultiProcess}
     *
