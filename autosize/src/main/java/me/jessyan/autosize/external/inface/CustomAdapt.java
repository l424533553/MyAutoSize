 ...
 */
package me.jessyan.autosize.external.inface;
...
public interface CustomAdapt {
    ...
    /**
     * {@link CustomAdapt #getSizeInDp} 须配合 {@link #isBaseOnWidth()} 使用, 规则如下:
     ...
     * 如果您不需要自定义设计图上的设计尺寸, 想继续使用在 AndroidManifest 中填写的设计图尺寸,{@link CustomAdapt #getSizeInDp} 则返回 {@code 0}
     *
