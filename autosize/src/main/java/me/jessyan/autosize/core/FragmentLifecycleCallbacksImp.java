...
/**
 * ================================================
 * {@link FragmentLifecycleCallbacksImp} 可用来代替在 BaseFragment 中加入适配代码的传统方式
 * {@link FragmentLifecycleCallbacksImp} 这种方案类似于 AOP, 面向接口, 侵入性低, 方便统一管理, 扩展性强, 并且也支持适配三方库的 {@link Fragment}
 * ================================================
 * @author LUOFAXIN
 * 说明：监听Fragment的创建，做好适配启动操作
 */
public class FragmentLifecycleCallbacksImp extends FragmentManager.FragmentLifecycleCallbacks {
    ...
    public FragmentLifecycleCallbacksImp(AutoAdaptStrategy autoAdaptStrategy) {
